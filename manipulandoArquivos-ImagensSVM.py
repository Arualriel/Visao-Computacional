...
#Modulo contendo a funcao do PCA e SVM, respectivamente
...
###aplicando o svm nos dados de treinamento###


clf = LinearSVC(tol=0.000001) #tolerancia
clf.fit(Y, K) 
...
# coleta os limites da janela da plotagem
ax = plt.gca()
xlim = ax.get_xlim()
ylim = ax.get_ylim()
